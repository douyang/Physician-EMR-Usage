...
medicineTeamFileWithLOS = open("UniquePatientDateTeamMedicineOnlyWithMedicineLOSAndFirstDay.csv", 'w')
linecount = 0
...
for line in medicineTeamFile2:
    ...
    if linecount2 == 0:
        medicineTeamFileWithLOS.write(line.strip() + ",medicineLOS,averageInternCensus,averageTeamCensus,FirstDayInternCensus,FirstDayTeamCensus\n")
        #print linecount2
        linecount2 += 1
        ...
        medicineTeamFileWithLOS.write(line.strip() + ',' + str(int(diffTime)) + ',' + str(sum(internCensus)/1.0/len(internCensus)) + ',' + str(sum(teamCensus)/1.0/len(teamCensus)) +
                                      ',' + str(internCensus[0]) + ',' + str(teamCensus[0]) + "\n")
